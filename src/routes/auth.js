...
router.post('/create-company', async (req, res) => {
  try {
    ...
    const { name, username, hqCity, hqState, hqLatitude, hqLongitude, hqCounty, hqNeighborhood, locationLatitude, locationLongitude, hqZone, landCost } = req.body;
...
const startingCash = 500000 - (parseFloat(landCost) || 0);
...
const companyResult = await pool.query(
     ...
     [name, dotNumber, mcNumber, ownerId, startingCash, hqState, hqCity, hqLatitude, hqLongitude, hqCounty, hqNeighborhood, locationLatitude, locationLongitude, hqZone]
   );
